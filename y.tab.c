...
static const yytype_uint8 yyrline[] =
{
      ...
      66,    71,    74,    78,    84,    86,    87,    88,    91,    96,
     103,   105,   106,   109,   111,   112,   115,   116,   117,   119,
     120,   121,   122,   123,   124,   125,   126,   127,   129,   130,
     131,   132,   134,   135,   137,   138,   140,   141,   144,   146,
     147,   149,   150,   151,   155,   156,   159,   160,   161,   162,
...
#line 91 "jac.y" /* yacc.c:1646  */
    {if(flagTreeErros ==1){(yyval.node)= new_node("MethodParam","MethodParam");
                                                                                  (yyvsp[0].node) = new_node("ParamDecl","ParamDecl");
                                                                                  add_son((yyval.node),(yyvsp[0].node));
                                                                                  add_brother((yyvsp[-2].node),new_node("Id",(yyvsp[-1].string)));  
                                                                                  add_son((yyvsp[0].node),(yyvsp[-2].node));                           };}
