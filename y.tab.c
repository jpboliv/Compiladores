...
static const yytype_uint8 yyrline[] =
{
     ...
     142,   143,   145,   146,   148,   149,   151,   152,   155,   161,
     162,   164,   165,   167,   168,   172,   173,   176,   177,   179,
...
#line 148 "jac.y" /* yacc.c:1646  */
    {if(flagTreeErros ==1){add_brother((yyval.node),(yyvsp[0].node));};}
